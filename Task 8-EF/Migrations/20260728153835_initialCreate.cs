    ...
    public partial class initialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_reviews", x => new { x.ReviewId, x.UserID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_orders_reviews_ReviewId_reviewUserID",
                        columns: x => new { x.ReviewId, x.reviewUserID },
                        principalTable: "reviews",
                        principalColumns: new[] { "ReviewId", "UserID" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_orders_ReviewId_reviewUserID",
                table: "orders",
                columns: new[] { "ReviewId", "reviewUserID" });
